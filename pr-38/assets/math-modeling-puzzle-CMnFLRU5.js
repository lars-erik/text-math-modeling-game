import{_ as e,a as t,b as n,c as r,d as i,f as a,g as o,h as s,i as c,m as l,n as u,o as d,p as f,r as p,s as m,t as h,v as g,x as _,y as v}from"./academic-relation-CHYACgqA.js";var y=[`zero`,`one`,`two`,`three`,`four`,`five`,`six`,`seven`,`eight`,`nine`,`ten`],ee={quantities:{basePower:{variableName:`basePower`,label:`base power`},droneCount:{variableName:`droneCount`,label:`number of drones`},dronePower:{variableName:`dronePower`,label:`power per drone`},totalPower:{variableName:`totalPower`,label:`total power`}},nouns:{ship:{singular:`ship`,plural:`ships`},drone:{singular:`drone`,plural:`drones`}},units:{count:`drones`,power:`MW`,powerPerDrone:`MW/drone`},formatNumber(e,t){let n=y[e]??String(e);return t?`${n.charAt(0).toUpperCase()}${n.slice(1)}`:n},fragments:{baseFact:{basicSystems:({noun:e,value:t,unit:n})=>`A ${e} uses ${t} ${n} for basic systems.`},countFact:{activeDrones:({count:e,noun:t})=>`It also powers ${e} identical active ${t}.`},totalFact:{combinedDraw:({value:e,unit:t})=>`The ship and its drones draw ${e} ${t} in total.`},question:{perDronePower:({noun:e})=>`How much power does one ${e} draw?`}}},te=[`null`,`én`,`to`,`tre`,`fire`,`fem`,`seks`,`sju`,`åtte`,`ni`,`ti`],b={en:ee,nb:{quantities:{basePower:{variableName:`grunnEffekt`,label:`grunnleggende effekt`},droneCount:{variableName:`droneAntall`,label:`antall droner`},dronePower:{variableName:`droneEffekt`,label:`effekt per drone`},totalPower:{variableName:`totalEffekt`,label:`samlet effekt`}},nouns:{ship:{singular:`skip`,plural:`skip`},drone:{singular:`drone`,plural:`droner`}},units:{count:`droner`,power:`MW`,powerPerDrone:`MW/drone`},formatNumber(e,t){let n=te[e]??String(e);return t?`${n.charAt(0).toUpperCase()}${n.slice(1)}`:n},fragments:{baseFact:{basicSystems:({noun:e,value:t,unit:n})=>`Et ${e} bruker ${t} ${n} til grunnleggende systemer.`},countFact:{activeDrones:({count:e,noun:t})=>`Det driver også ${e} identiske aktive ${t}.`},totalFact:{combinedDraw:({value:e,unit:t})=>`Skipet og dronene trekker til sammen ${e} ${t}.`},question:{perDronePower:({noun:e})=>`Hvor mye effekt trekker én ${e}?`}}}};function ne(e,t){let n=b[t];return Object.fromEntries(e.map(e=>[n.quantities[e.themeQuantityId].variableName,e.canonicalId]))}function re(e,t,n){let r=b[n],i=new Map(e.map(e=>[e.themeQuantityId,e])),a=t.sentences.map(e=>{let t=x(i,e.factId);switch(e.fragmentKey){case`baseFact.basicSystems`:return r.fragments.baseFact.basicSystems({noun:r.nouns[e.nounKey].singular,value:String(t.value),unit:r.units.power});case`countFact.activeDrones`:return r.fragments.countFact.activeDrones({count:r.formatNumber(t.value,!1),noun:ie(r.nouns[e.nounKey],t.value),isSingular:t.value===1});case`totalFact.combinedDraw`:return r.fragments.totalFact.combinedDraw({value:String(t.value),unit:r.units.power})}});if(i.get(t.question.factId)?.visibility!==`hidden`)throw Error(`Story question fact ${t.question.factId} must be hidden.`);let o=r.fragments.question.perDronePower({noun:r.nouns[t.question.nounKey].singular});return{text:[...a,o].join(` `),replay:{locale:n,scenarioId:`gaming.drone-power`,storySeed:t.seed}}}function x(e,t){let n=e.get(t);if(n?.visibility!==`known`||n.value===void 0)throw Error(`Story sentence fact ${t} must have a known value.`);return{...n,visibility:`known`,value:n.value}}function ie(e,t){return t===1?e.singular:e.plural}function S(e,t){let n=new Map(e.map(e=>[e.role,e.themeQuantityId]));return{scenarioId:`gaming.drone-power`,seed:t,sentences:[{fragmentKey:`baseFact.basicSystems`,factId:C(n,`base`),nounKey:`ship`},{fragmentKey:`countFact.activeDrones`,factId:C(n,`count`),nounKey:`drone`},{fragmentKey:`totalFact.combinedDraw`,factId:C(n,`total`)}],question:{fragmentKey:`question.perDronePower`,factId:C(n,`per-item`),nounKey:`drone`}}}function C(e,t){let n=e.get(t);if(n===void 0)throw Error(`Drone-power story needs a fact with role ${t}.`);return n}var w={base:{themeQuantityId:`basePower`,unitKey:`power`},count:{themeQuantityId:`droneCount`,unitKey:`count`},"per-item":{themeQuantityId:`dronePower`,unitKey:`powerPerDrone`},total:{themeQuantityId:`totalPower`,unitKey:`power`}},ae={id:`gaming.drone-power`,present({problem:e,locale:t,storySeed:n}){let r=b[t],i=e.quantities.map(e=>{if(e.role===void 0)throw Error(`Quantity ${e.id} has no total-from-parts role.`);let t=w[e.role],n=r.quantities[t.themeQuantityId];return{themeQuantityId:t.themeQuantityId,canonicalId:e.id,role:e.role,visibility:e.given.kind,...e.given.kind===`known`?{value:e.given.value}:{},label:n.label,variableName:n.variableName,unit:r.units[t.unitKey]}}),a=re(i,S(i,n),t);return{themeId:`gaming.drone-power`,locale:t,facts:i,story:{text:a.text,storySeed:a.replay.storySeed},learnerNames:ne(i,t)}}},oe=[`zero`,`one`,`two`,`three`,`four`,`five`,`six`,`seven`,`eight`,`nine`,`ten`],se={quantities:{startingFollowers:{variableName:`startingFollowers`,label:`starting followers`},promotedPostCount:{variableName:`promotedPostCount`,label:`number of promoted posts`},followersPerPost:{variableName:`followersPerPost`,label:`followers per post`},finalFollowers:{variableName:`finalFollowers`,label:`final followers`}},nouns:{creator:{singular:`creator`,plural:`creators`},post:{singular:`post`,plural:`posts`}},units:{followers:`followers`,posts:`posts`,followersPerPost:`followers/post`},formatNumber(e,t){return oe[e]??String(e)},fragments:{baseFact:{startingAudience:({noun:e,value:t,unit:n})=>`A ${e} starts with ${t} ${n}.`},countFact:{promotedPosts:({count:e,noun:t})=>`Each of ${e} promoted ${t} gains the same number of followers.`},totalFact:{finalAudience:({value:e,unit:t})=>`The creator finishes with ${e} ${t}.`},question:{followersPerPost:({noun:e})=>`How many followers does each ${e} gain?`}}},ce=[`null`,`ett`,`to`,`tre`,`fire`,`fem`,`seks`,`sju`,`åtte`,`ni`,`ti`],T={en:se,nb:{quantities:{startingFollowers:{variableName:`startFoelgere`,label:`følgere ved start`},promotedPostCount:{variableName:`promoterteInnlegg`,label:`antall promoterte innlegg`},followersPerPost:{variableName:`foelgerePerInnlegg`,label:`følgere per innlegg`},finalFollowers:{variableName:`sluttFoelgere`,label:`følgere til slutt`}},nouns:{creator:{singular:`innholdsskaper`,plural:`innholdsskapere`},post:{singular:`innlegg`,plural:`innlegg`}},units:{followers:`følgere`,posts:`innlegg`,followersPerPost:`følgere/innlegg`},formatNumber(e,t){return ce[e]??String(e)},fragments:{baseFact:{startingAudience:({noun:e,value:t,unit:n})=>`En ${e} starter med ${t} ${n}.`},countFact:{promotedPosts:({count:e,noun:t})=>`${e.charAt(0).toUpperCase()}${e.slice(1)} promoterte ${t} gir like mange nye følgere hver.`},totalFact:{finalAudience:({value:e,unit:t})=>`Innholdsskaperen ender med ${e} ${t}.`},question:{followersPerPost:({noun:e})=>`Hvor mange følgere gir hvert ${e}?`}}}};function E(e,t){let n=T[t];return Object.fromEntries(e.map(e=>[n.quantities[e.themeQuantityId].variableName,e.canonicalId]))}function D(e,t,n){let r=T[n],i=new Map(e.map(e=>[e.themeQuantityId,e])),a=t.sentences.map(e=>{let t=O(i,e.factId);switch(e.fragmentKey){case`baseFact.startingAudience`:return r.fragments.baseFact.startingAudience({noun:r.nouns[e.nounKey].singular,value:String(t.value),unit:r.units.followers});case`countFact.promotedPosts`:return r.fragments.countFact.promotedPosts({count:r.formatNumber(t.value,!1),noun:t.value===1?r.nouns[e.nounKey].singular:r.nouns[e.nounKey].plural});case`totalFact.finalAudience`:return r.fragments.totalFact.finalAudience({value:String(t.value),unit:r.units.followers})}});if(i.get(t.question.factId)?.visibility!==`hidden`)throw Error(`Story question fact ${t.question.factId} must be hidden.`);let o=r.fragments.question.followersPerPost({noun:r.nouns[t.question.nounKey].singular});return{text:[...a,o].join(` `),replay:{locale:n,scenarioId:`creator.followers`,storySeed:t.seed}}}function O(e,t){let n=e.get(t);if(n?.visibility!==`known`||n.value===void 0)throw Error(`Story sentence fact ${t} must have a known value.`);return{...n,visibility:`known`,value:n.value}}function le(e,t){let n=new Map(e.map(e=>[e.role,e.themeQuantityId]));return{scenarioId:`creator.followers`,seed:t,sentences:[{fragmentKey:`baseFact.startingAudience`,factId:k(n,`base`),nounKey:`creator`},{fragmentKey:`countFact.promotedPosts`,factId:k(n,`count`),nounKey:`post`},{fragmentKey:`totalFact.finalAudience`,factId:k(n,`total`)}],question:{fragmentKey:`question.followersPerPost`,factId:k(n,`per-item`),nounKey:`post`}}}function k(e,t){let n=e.get(t);if(n===void 0)throw Error(`Creator-followers story needs a fact with role ${t}.`);return n}var ue={base:{themeQuantityId:`startingFollowers`,unitKey:`followers`},count:{themeQuantityId:`promotedPostCount`,unitKey:`posts`},"per-item":{themeQuantityId:`followersPerPost`,unitKey:`followersPerPost`},total:{themeQuantityId:`finalFollowers`,unitKey:`followers`}},de={"gaming.drone-power":ae,"creator.followers":{id:`creator.followers`,present({problem:e,locale:t,storySeed:n}){let r=T[t],i=e.quantities.map(e=>{if(e.role===void 0)throw Error(`Quantity ${e.id} has no total-from-parts role.`);let t=ue[e.role],n=r.quantities[t.themeQuantityId];return{themeQuantityId:t.themeQuantityId,canonicalId:e.id,role:e.role,visibility:e.given.kind,...e.given.kind===`known`?{value:e.given.value}:{},label:n.label,variableName:n.variableName,unit:r.units[t.unitKey]}}),a=D(i,le(i,n),t);return{themeId:`creator.followers`,locale:t,facts:i,story:{text:a.text,storySeed:a.replay.storySeed},learnerNames:E(i,t)}}}};function fe(e){return[{id:`matching`,relation:e.relation},{id:`factor-into-group`,relation:pe(e.relation)}]}function pe(e){return{kind:`equation`,left:e.left,right:me(e.right)}}function me(e){if(e.kind!==`add`||e.right.kind!==`multiply`||e.left.kind===`multiply`)return e;let t=e.right;return{kind:`multiply`,left:t.left,right:{kind:`add`,left:e.left,right:t.right}}}function A(e){let t=[],n=new Set;return j(e.left,t,n),j(e.right,t,n),t}function j(e,t,n){switch(e.kind){case`literal`:return;case`quantity`:n.has(e.id)||(n.add(e.id),t.push(e.id));return;case`add`:case`multiply`:j(e.left,t,n),j(e.right,t,n)}}function M(e,t){return`${N(e.left,t,0)} = ${N(e.right,t,0)}`}function N(e,t,n){let r=P(e),i;switch(e.kind){case`literal`:i=String(e.value);break;case`quantity`:i=F(t,e.id);break;case`add`:i=`${N(e.left,t,r)} + ${N(e.right,t,r)}`;break;case`multiply`:i=`${N(e.left,t,r)} * ${N(e.right,t,r)}`}return r<n?`(${i})`:i}function P(e){return e.kind===`add`?1:e.kind===`multiply`?2:3}function F(e,t){let n=e[t];if(n===void 0)throw Error(`No learner-facing name for canonical quantity ${t}.`);return n}function I(e){return z(e,R(e))}function L(e){let t=U(e),{state:n,feedback:r,submission:i}=s[e.modeId].submit({problem:e.problem,locale:e.locale,answer:e.answer,names:t.learnerNames});return z(e,{state:n,feedback:r,submission:i})}function R(e){return s[e.modeId].start({problem:e.problem,locale:e.locale})}function z(t,n){let r=U(t),i=ve(r),a=e[t.locale];return{screen:_e(t,n.state,i,r),context:{locale:t.locale,themeId:r.themeId,story:r.story.text,quantities:i,replay:ye(t,r)},submission:n.submission,feedback:n.feedback===void 0?void 0:he(n.feedback,r,a)}}function he(e,t,n){if(e.kind!==`misconception`||e.message!==void 0)return e;let r=new Map(t.facts.map(e=>[e.canonicalId,e.label])),i=r.get(e.misconception.baseQuantityId),a=r.get(e.misconception.countQuantityId);return i===void 0||a===void 0?e:{...e,message:n.misconceptions.baseAppliedPerItem(ge(i),a)}}function ge(e){return`${e.charAt(0).toUpperCase()}${e.slice(1)}`}function _e(t,n,r,i){let a=e[t.locale];switch(n.modeId){case`story-to-quantities`:return{modeId:`story-to-quantities`,source:{kind:`story`},target:{kind:`quantities`,prompt:a.storyToQuantities.prompt,quantities:r},input:n.input};case`quantities-to-named-equation`:return{modeId:`quantities-to-named-equation`,source:{kind:`quantities`,quantities:r},target:n.target,input:n.input};case`named-equation-to-academic-notation`:{let e=B(i);return{modeId:n.modeId,source:{...n.source,names:e},target:n.target,symbolKey:V(n.target.symbols,i,n.source.relation),input:n.input}}case`academic-notation-to-named-equation`:return{modeId:n.modeId,source:n.source,target:{...n.target,names:B(i)},symbolKey:V(n.source.symbols,i,n.source.relation),input:n.input}}}function B(e){return Object.fromEntries(e.facts.map(e=>[e.canonicalId,e.variableName]))}function V(e,t,n){let r=new Set(A(n));return t.facts.flatMap(t=>r.has(t.canonicalId)?[{canonicalId:t.canonicalId,symbol:e[t.canonicalId],variableName:t.variableName}]:[])}function ve(e){return e.facts.map(e=>({id:e.canonicalId,themeQuantityId:e.themeQuantityId,label:e.label,variableName:e.variableName,displayValue:e.visibility===`known`?`${e.value} ${e.unit}`:`?`,role:e.role,given:e.visibility===`known`&&e.value!==void 0?{kind:`known`,value:e.value}:{kind:`hidden`}}))}function ye(e,t){return e.problem.replay?{...e.problem.replay,locale:e.locale,themeId:t.themeId,storySeed:t.story.storySeed}:void 0}function H(e,t,n,r){let i=de[e];if(i===void 0)throw Error(`Unknown theme ${e}.`);return i.present({problem:t,locale:n,storySeed:r})}function U(e){return H(e.themeId,e.problem,e.locale,e.storySeed??e.problem.replay?.seed??0)}function be(e,t){return xe(fe(e),t)}function xe(e,t){let n=new Map(t.facts.map(e=>[e.canonicalId,e.variableName]));return e.map(e=>({id:e.id,label:Se(e.relation,n),relation:e.relation}))}function Se(e,t){return M(e,Object.fromEntries(t))}function Ce(){return`run-${typeof globalThis.crypto?.randomUUID==`function`?globalThis.crypto.randomUUID():`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,10)}`}`}var W=`session-plan-v1`,we=5;function Te(e){if(!Number.isSafeInteger(e.seed)||e.seed<0||e.seed>4294967295)throw Error(`Session seed must be a non-negative 32-bit unsigned integer.`);let t=e.randomSource??i(e.seed),n=Ee(t),r=De(e.seed,n,t);return{seed:e.seed,plannerVersion:W,length:n,items:r}}function Ee(e){return we+Math.floor(e.nextFloat()*6)}function De(e,t,n){let r=ke([...v],n),i=[];for(let n=0;n<t;n+=1)i.push({index:n+1,problemSeed:Oe(e,n),modeId:r[n%r.length]});return i}function Oe(e,t){return G(G(e>>>0)^t+1>>>0)>>>0}function ke(e,t){for(let n=e.length-1;n>0;--n){let r=Math.floor(t.nextFloat()*(n+1)),i=e[n];e[n]=e[r],e[r]=i}return e}function G(e){let t=e>>>0;return t=Math.imul(t^t>>>16,2146121005),t^=t>>>15,t=Math.imul(t^t>>>15,782666323),t^=t>>>15,t}function Ae(e){return je(e,Ce())}function je(e,t){let n=Te({seed:e.seed});return K({...e,runId:t},n,0,[],void 0,void 0)}function K(e,t,n,r,i,a,s=!1){let c={options:e,plan:t,currentIndex:n,answerLog:r,currentScreen:i??Re(e,t,n),currentProblem:i===void 0?J(t,n):void 0,hint:a,currentCompleted:s};return c.currentScreen===void 0?q(e,t,r,void 0):{replay:{seed:e.seed,plannerVersion:W,themeId:e.themeId,locale:e.locale},runId:e.runId,plan:t,status:`active`,currentIndex:n,position:n+1,total:t.length,screen:c.currentScreen,currentProblem:Y(c),hint:a,answerLog:r,availableNext:c.currentCompleted,summary:void 0,submit(i){let o=L({problem:Y(c),themeId:e.themeId,modeId:t.items[n].modeId,locale:e.locale,storySeed:t.items[n].problemSeed,answer:i}),s=Me.has(o.feedback?.kind??`none`);return K(e,t,n,Pe(r,{itemIndex:t.items[n].index,modeId:t.items[n].modeId,submission:Fe(o),accepted:s}),o,s?void 0:a,s)},requestHint(){let i=o({modeId:t.items[n].modeId,guidance:Y(c).guidance??[]});return i===void 0||a?.guidanceId===i.id?this:K(e,t,n,r,c.currentScreen,{guidanceId:i.id},s)},next(){return c.currentCompleted?n+1>=t.length?q(e,t,r,c.currentScreen):K(e,t,n+1,r,void 0,void 0):this},withLocale(i){return i===e.locale?this:K({...e,locale:i},t,n,r,Le(c,e,i),a,c.currentCompleted)}}}function q(e,t,n,r){let i=Ie(n.filter(e=>e.accepted).map(e=>e.modeId));return{replay:{seed:e.seed,plannerVersion:W,themeId:e.themeId,locale:e.locale},runId:e.runId,plan:t,status:`complete`,currentIndex:t.length-1,position:t.length,total:t.length,screen:r,currentProblem:void 0,hint:void 0,answerLog:n,availableNext:!1,summary:{total:n.filter(e=>e.accepted).length,counts:i},submit:()=>{throw Error(`The session is complete; there is nothing to submit.`)},requestHint:()=>{throw Error(`The session is complete; there is no hint to request.`)},next:()=>{throw Error(`The session is complete; there is no next item.`)},withLocale:i=>q({...e,locale:i},t,n,r)}}var Me=new Set([`accepted`,`quantity-selection-accepted`]);function Ne(e){if(e.hint!==void 0&&e.currentProblem!==void 0)return e.currentProblem.guidance?.find(t=>t.id===e.hint?.guidanceId)}function Pe(e,t){let n=e.findIndex(e=>e.itemIndex===t.itemIndex);return n===-1?[...e,t]:e.map((e,r)=>r===n?t:e)}function Fe(e){if(e.submission===void 0)throw Error(`A submitted session item requires a submission.`);return e.submission}function Ie(e){let t={};for(let e of v)t[e]=0;for(let n of e)t[n]+=1;return t}function Le(e,t,n){let r=e.plan.items[e.currentIndex];if(r!==void 0)return I({problem:Y(e),themeId:t.themeId,modeId:r.modeId,locale:n,storySeed:r.problemSeed})}function J(e,t){return f({seed:e.items[t].problemSeed,config:a}).problem}function Re(e,t,n){if(!(n>=t.length))return I({problem:J(t,n),themeId:e.themeId,modeId:t.items[n].modeId,locale:e.locale,storySeed:t.items[n].problemSeed})}function Y(e){return e.currentProblem===void 0?J(e.plan,e.currentIndex):e.currentProblem}var ze=class extends p{static properties={choices:{attribute:!1},selectedChoiceId:{attribute:!1},legend:{attribute:!1},checkLabel:{attribute:!1}};static styles=t`
    :host {
      display: block;
      min-width: 0;
    }
  ...
  `;constructor(){super(),this.value=``,this.inputLabel=`Named equation`,this.checkLabel=`Check`}render(){return c`
    ...
    `},text:{label:`Text input`,render:({screen:e,resources:t})=>c`
      ...
      ></named-equation-text-input>
    `}};function Ve(e){return Object.hasOwn(X,e)}var Z={render(e,t,n){n.textContent=h(e,t)}},He=class extends p{static properties={screen:{attribute:!1},knownLegend:{attribute:!1},unknownLegend:{attribute:!1},checkLabel:{attribute:!1}};static styles=t`
    :host {
      display: block;
      min-width: 0;
    }
  ...
  `;constructor(){super(),this.seed=`17`,this.session=``,this.themeId=`gaming.drone-power`,this.modeId=`story-to-quantities`,this.inputMode=`text`,this.locale=`en`,this.academicDisplayAdapter=Z,this.screen=void 0,this.generatedProblem=$(17),this.activeSession=void 0}willUpdate(e){if(e.has(`session`)||e.has(`themeId`)||e.has(`locale`)){let t=e.has(`locale`)&&!e.has(`session`)&&!e.has(`themeId`)&&this.activeSession!==void 0;this.activeSession=t?this.activeSession?.withLocale(this.locale):this.composeCurrentSession()}e.has(`seed`)&&(this.generatedProblem=$(Number(this.seed))),(e.has(`seed`)||e.has(`themeId`)||e.has(`modeId`)||e.has(`locale`)||e.has(`session`))&&(this.screen=this.activeSession===void 0?this.composeCurrentScreen():this.activeSession.screen)}composeCurrentSession(){if(this.session&&n(this.themeId)&&_(this.locale))return Ae({seed:Number(this.session),themeId:this.themeId,locale:this.locale})}composeCurrentScreen(){if(n(this.themeId)&&_(this.locale))return I({problem:this.generatedProblem,themeId:this.themeId,modeId:g(this.modeId)?this.modeId:`story-to-quantities`,locale:this.locale,storySeed:Number(this.seed)})}render(){if(!n(this.themeId))return c`<p role="alert">
        ...
        Unknown locale ${JSON.stringify(this.locale)}.
          ...
          <p class="equation">
            ${M(e.screen.source.relation,e.screen.source.names)}
          </p>
      ...
      ${i===void 0||e.screen.modeId!==`named-equation-to-academic-notation`?null:c`<academic-notation-display
            ...
            .adapter=${this.academicDisplayAdapter}
          ></academic-notation-display>`}
    </div>`}renderNamedEquationInput(t){if(!Ve(this.inputMode))return c`<p role="alert">
        Unknown input mode ${JSON.stringify(this.inputMode)}.
      </p>`;let r=this.screen;if(r===void 0||!n(this.themeId))return c``;let i=this.currentProblemFor(),a=e[t],o=X[this.inputMode],s=be(i,H(this.themeId,i,t,r.context.replay?.storySeed??Number(this.seed)));return c`<div @puzzle-answer=${this.handleAnswer}>
