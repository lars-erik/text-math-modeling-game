...
\f\r]`,R=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ie=/-->/g,Le=/>/g,z=RegExp(`>|${L}(?:([^\\s"'>=/]+)(${L}*=${L}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),Re=/'/g,ze=/"/g,Be=/^(?:script|style|textarea|title)$/i,B=(e=>(t,...n)=>({_$litType$:e,strings:t,values:n}))(1),V=Symbol.for(`lit-noChange`),H=Symbol.for(`lit-nothing`),Ve=new WeakMap,U=N.createTreeWalker(N,129);function He(e,t){if(!I(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return A===void 0?t:A.createHTML(t)}var Ue=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=R;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===R?c[1]===`!--`?o=Ie:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=z):(Be.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=z):o=Le:o===z?c[0]===`>`?(o=i??R,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?z:c[3]===`"`?ze:Re):o===ze||o===Re?o=z:o===Ie||o===Le?o=R:(o=z,i=void 0);let d=o===z&&e[t+1].startsWith(`/>`)?` `:``;a+=o===R?n+Pe:l>=0?(r.push(s),n.slice(0,l)+j+n.slice(l)+M+d):n+M+(l===-2?t:d)}return[He(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]},W=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=Ue(t,n);if(this.el=e.createElement(l,r),U.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=U.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(j)){let t=u[o++],n=i.getAttribute(e).split(M),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?Ge:r[1]===`?`?Ke:r[1]===`@`?qe:q}),i.removeAttribute(e)}else e.startsWith(M)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(Be.test(i.tagName)){let e=i.textContent.split(M),t=e.length-1;if(t>0){i.textContent=k?k.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],P()),U.nextNode(),c.push({type:2,index:++a});i.append(e[t],P())}}}else if(i.nodeType===8){if(i.data===Ne)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(M,e+1))!==-1;)c.push({type:7,index:a}),e+=M.length-1}}a++}}static createElement(e,t){let n=N.createElement(`template`);return n.innerHTML=e,n}};function G(e,t,n=e,r){if(t===V)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=F(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=G(e,i._$AS(e,t.values),i,r)),t}var We=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??N).importNode(t,!0);U.currentNode=r;let i=U.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new K(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new Je(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=U.nextNode(),a++)}return U.currentNode=N,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},K=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=H,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=G(this,e,t),F(e)?e===H||e==null||e===``?(this._$AH!==H&&this._$AR(),this._$AH=H):e!==this._$AH&&e!==V&&this._(e):e._$litType$===void 0?e.nodeType===void 0?Fe(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==H&&F(this._$AH)?this._$AA.nextSibling.data=e:this.T(N.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=W.createElement(He(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new We(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=Ve.get(e.strings);return t===void 0&&Ve.set(e.strings,t=new W(e)),t}k(t){I(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(P()),this.O(P()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=O(e).nextSibling;O(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},q=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=H,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=H}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=G(this,e,t,0),a=!F(e)||e!==this._$AH&&e!==V,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=G(this,r[n+o],t,o),s===V&&(s=this._$AH[o]),a||=!F(s)||s!==this._$AH[o],s===H?e=H:e!==H&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===H?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},Ge=class extends q{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===H?void 0:e}},Ke=class extends q{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==H)}},qe=class extends q{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=G(this,e,t,0)??H)===V)return;let n=this._$AH,r=e===H&&n!==H||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==H&&(n===H||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Je=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){G(this,e)}},Ye=D.litHtmlPolyfillSupport;Ye?.(W,K),(D.litHtmlVersions??=[]).push(`3.3.3`);var Xe=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new K(t.insertBefore(P(),e),e,void 0,n??{})}return i._$AI(e),i},J=globalThis,Y=class extends E{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Xe(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return V}};Y._$litElement$=!0,Y.finalized=!0,J.litElementHydrateSupport?.({LitElement:Y});var Ze=J.litElementPolyfillSupport;Ze?.({LitElement:Y}),(J.litElementVersions??=[]).push(`4.2.2`);function Qe(e){let t=[],n=new Set;return X(e.left,t,n),X(e.right,t,n),t}function X(e,t,n){switch(e.kind){case`literal`:return;case`quantity`:n.has(e.id)||(n.add(e.id),t.push(e.id));return;case`add`:case`multiply`:X(e.left,t,n),X(e.right,t,n)}}function $e(e,t){return`${Z(e.left,t,0)} = ${Z(e.right,t,0)}`}function Z(e,t,n){let r=et(e),i;switch(e.kind){case`literal`:i=String(e.value);break;case`quantity`:i=tt(t,e.id);break;case`add`:i=`${Z(e.left,t,r)} + ${Z(e.right,t,r)}`;break;case`multiply`:i=`${Z(e.left,t,r)} * ${Z(e.right,t,r)}`}return r<n?`(${i})`:i}function et(e){return e.kind===`add`?1:e.kind===`multiply`?2:3}function tt(e,t){let n=e[t];if(n===void 0)throw Error(`No learner-facing name for canonical quantity ${t}.`);return n}function nt(e){return at(e,it(e))}function rt(e){let t=ft(e),{state:n,feedback:r,submission:i}=a[e.modeId].submit({problem:e.problem,locale:e.locale,answer:e.answer,names:t.learnerNames});return at(e,{state:n,feedback:r,submission:i})}function it(e){return a[e.modeId].start({problem:e.problem,locale:e.locale})}function at(e,t){let n=ft(e),r=lt(n);return{screen:ot(e,t.state,r,n),context:{locale:e.locale,themeId:n.themeId,story:n.story.text,quantities:r,replay:ut(e,n)},submission:t.submission,feedback:t.feedback}}function ot(e,t,n,r){let i=s[e.locale];switch(t.modeId){case`story-to-quantities`:return{modeId:`story-to-quantities`,source:{kind:`story`},target:{kind:`quantities`,prompt:i.storyToQuantities.prompt,quantities:n},input:t.input};case`quantities-to-named-equation`:return{modeId:`quantities-to-named-equation`,source:{kind:`quantities`,quantities:n},target:t.target,input:t.input};case`named-equation-to-academic-notation`:{let e=st(r);return{modeId:t.modeId,source:{...t.source,names:e},target:t.target,symbolKey:ct(t.target.symbols,r,t.source.relation),input:t.input}}case`academic-notation-to-named-equation`:return{modeId:t.modeId,source:t.source,target:{...t.target,names:st(r)},symbolKey:ct(t.source.symbols,r,t.source.relation),input:t.input}}}function st(e){return Object.fromEntries(e.facts.map(e=>[e.canonicalId,e.variableName]))}function ct(e,t,n){let r=new Set(Qe(n));return t.facts.flatMap(t=>r.has(t.canonicalId)?[{canonicalId:t.canonicalId,symbol:e[t.canonicalId],variableName:t.variableName}]:[])}function lt(e){return e.facts.map(e=>({id:e.canonicalId,themeQuantityId:e.themeQuantityId,label:e.label,variableName:e.variableName,displayValue:e.visibility===`known`?`${e.value} ${e.unit}`:`?`,role:e.role,given:e.visibility===`known`&&e.value!==void 0?{kind:`known`,value:e.value}:{kind:`hidden`}}))}function ut(e,t){return e.problem.replay?{...e.problem.replay,locale:e.locale,themeId:t.themeId,storySeed:t.story.storySeed}:void 0}function dt(e,t,n,r){let i=ge[e];if(i===void 0)throw Error(`Unknown theme ${e}.`);return i.present({problem:t,locale:n,storySeed:r})}function ft(e){return dt(e.themeId,e.problem,e.locale,e.storySeed??e.problem.replay?.seed??0)}function pt(e,t){return mt(_e(e),t)}function mt(e,t){let n=new Map(t.facts.map(e=>[e.canonicalId,e.variableName]));return e.map(e=>({id:e.id,label:ht(e.relation,n),relation:e.relation}))}function ht(e,t){return $e(e,Object.fromEntries(t))}var gt=class extends Y{static properties={choices:{attribute:!1},selectedChoiceId:{attribute:!1},legend:{attribute:!1},checkLabel:{attribute:!1}};static styles=y`
  ...
  `;constructor(){super(),this.value=``,this.inputLabel=`Named equation`,this.checkLabel=`Check`}render(){return B`
    ...
    `},text:{label:`Text input`,render:({screen:e,resources:t})=>B`
      ...
      ></named-equation-text-input>
    `}};function vt(e){return Object.hasOwn(Q,e)}var yt={render(e,t,n){n.textContent=c(e,t)}},bt=class extends Y{static properties={screen:{attribute:!1},knownLegend:{attribute:!1},unknownLegend:{attribute:!1},checkLabel:{attribute:!1}};static styles=y`
    :host {
      display: block;
      min-width: 0;
    }
  ...
  `;constructor(){super(),this.seed=`17`,this.themeId=`gaming.drone-power`,this.modeId=`story-to-quantities`,this.inputMode=`text`,this.locale=`en`,this.academicDisplayAdapter=yt,this.screen=void 0,this.generatedProblem=$(17)}willUpdate(e){e.has(`seed`)&&(this.generatedProblem=$(Number(this.seed))),(e.has(`seed`)||e.has(`themeId`)||e.has(`modeId`)||e.has(`locale`))&&(this.screen=this.composeCurrentScreen())}composeCurrentScreen(){if(r(this.themeId)&&l(this.locale))return nt({problem:this.generatedProblem,themeId:this.themeId,modeId:t(this.modeId)?this.modeId:`story-to-quantities`,locale:this.locale,storySeed:Number(this.seed)})}render(){if(!r(this.themeId))return B`<p role="alert">
      ...
      ${i===void 0||e.screen.modeId!==`named-equation-to-academic-notation`?null:B`<academic-notation-display
            ...
            .adapter=${this.academicDisplayAdapter}
          ></academic-notation-display>`}
    </div>`}renderNamedEquationInput(e){if(!vt(this.inputMode))return B`<p role="alert">
        Unknown input mode ${JSON.stringify(this.inputMode)}.
      </p>`;let t=this.screen;if(t===void 0||!r(this.themeId))return B``;let n=s[e],i=Q[this.inputMode],a=pt(this.generatedProblem,dt(this.themeId,this.generatedProblem,e,Number(this.seed)));return B`<div @puzzle-answer=${this.handleAnswer}>
    ...
    </div>`}handleAnswer(e){this.submitAnswer(e.detail)}submitAnswer(e){r(this.themeId)&&t(this.modeId)&&l(this.locale)&&(this.screen=rt({problem:this.generatedProblem,themeId:this.themeId,modeId:this.modeId,locale:this.locale,storySeed:Number(this.seed),answer:e}))}selectInputMode(e){this.inputMode=e,this.screen=this.composeCurrentScreen()}handleQuantitySelection(e){this.submitAnswer(e.detail)}handleLocaleChange(e){if(e.currentTarget instanceof HTMLSelectElement&&l(e.currentTarget.value)){let t=e.currentTarget.value;this.locale=t,this.requestApplicationState({locale:t})}}requestApplicationState(n){this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0,detail:{seed:Number(this.seed),themeId:r(this.themeId)?this.themeId:`gaming.drone-power`,modeId:t(this.modeId)?this.modeId:`story-to-quantities`,locale:n.locale}}))}renderShell({locale:e,heading:t,prompt:n,source:r,input:i,feedback:a,replay:o}){let c=s[e];return B`
      <puzzle-shell
        .heading=${t}
      ...
      >
        ...
        ${o===void 0?null:B`<dl slot="replay" class="replay-list">
              <dt>${c.common.seed}</dt>
              <dd>${o.seed}</dd>
    ...
    `}};function $(e){return o({seed:Number.isSafeInteger(e)?e:17,config:i}).problem}customElements.get(`math-modeling-puzzle`)===void 0&&customElements.define(`math-modeling-puzzle`,wt);export{wt as MathModelingPuzzle};