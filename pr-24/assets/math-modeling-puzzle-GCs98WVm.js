...
\f\r]`,F=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Re=/-->/g,ze=/>/g,I=RegExp(`>|${P}(?:([^\\s"'>=/]+)(${P}*=${P}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),Be=/'/g,L=/"/g,R=/^(?:script|style|textarea|title)$/i,z=(e=>(t,...n)=>({_$litType$:e,strings:t,values:n}))(1),B=Symbol.for(`lit-noChange`),V=Symbol.for(`lit-nothing`),Ve=new WeakMap,H=A.createTreeWalker(A,129);function He(e,t){if(!N(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return Pe===void 0?t:Pe.createHTML(t)}var Ue=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=F;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===F?c[1]===`!--`?o=Re:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=I):(R.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=I):o=ze:o===I?c[0]===`>`?(o=i??F,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?I:c[3]===`"`?L:Be):o===L||o===Be?o=I:o===Re||o===ze?o=F:(o=I,i=void 0);let d=o===I&&e[t+1].startsWith(`/>`)?` `:``;a+=o===F?n+Ie:l>=0?(r.push(s),n.slice(0,l)+O+n.slice(l)+k+d):n+k+(l===-2?t:d)}return[He(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]},U=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=Ue(t,n);if(this.el=e.createElement(l,r),H.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=H.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(O)){let t=u[o++],n=i.getAttribute(e).split(k),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?Ge:r[1]===`?`?Ke:r[1]===`@`?qe:K}),i.removeAttribute(e)}else e.startsWith(k)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(R.test(i.tagName)){let e=i.textContent.split(k),t=e.length-1;if(t>0){i.textContent=D?D.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],j()),H.nextNode(),c.push({type:2,index:++a});i.append(e[t],j())}}}else if(i.nodeType===8){if(i.data===Fe)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(k,e+1))!==-1;)c.push({type:7,index:a}),e+=k.length-1}}a++}}static createElement(e,t){let n=A.createElement(`template`);return n.innerHTML=e,n}};function W(e,t,n=e,r){if(t===B)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=M(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=W(e,i._$AS(e,t.values),i,r)),t}var We=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??A).importNode(t,!0);H.currentNode=r;let i=H.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new G(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new Je(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=H.nextNode(),a++)}return H.currentNode=A,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},G=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=V,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=W(this,e,t),M(e)?e===V||e==null||e===``?(this._$AH!==V&&this._$AR(),this._$AH=V):e!==this._$AH&&e!==B&&this._(e):e._$litType$===void 0?e.nodeType===void 0?Le(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==V&&M(this._$AH)?this._$AA.nextSibling.data=e:this.T(A.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=U.createElement(He(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new We(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=Ve.get(e.strings);return t===void 0&&Ve.set(e.strings,t=new U(e)),t}k(t){N(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(j()),this.O(j()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=E(e).nextSibling;E(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},K=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=V,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=V}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=W(this,e,t,0),a=!M(e)||e!==this._$AH&&e!==B,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=W(this,r[n+o],t,o),s===B&&(s=this._$AH[o]),a||=!M(s)||s!==this._$AH[o],s===V?e=V:e!==V&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===V?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},Ge=class extends K{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===V?void 0:e}},Ke=class extends K{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==V)}},qe=class extends K{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=W(this,e,t,0)??V)===B)return;let n=this._$AH,r=e===V&&n!==V||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==V&&(n===V||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Je=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){W(this,e)}},Ye=T.litHtmlPolyfillSupport;Ye?.(U,G),(T.litHtmlVersions??=[]).push(`3.3.3`);var Xe=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new G(t.insertBefore(j(),e),e,void 0,n??{})}return i._$AI(e),i},q=globalThis,J=class extends w{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Xe(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return B}};J._$litElement$=!0,J.finalized=!0,q.litElementHydrateSupport?.({LitElement:J});var Ze=q.litElementPolyfillSupport;Ze?.({LitElement:J}),(q.litElementVersions??=[]).push(`4.2.2`);function Qe(e){let t=[],n=new Set;return Y(e.left,t,n),Y(e.right,t,n),t}function Y(e,t,n){switch(e.kind){case`literal`:return;case`quantity`:n.has(e.id)||(n.add(e.id),t.push(e.id));return;case`add`:case`multiply`:Y(e.left,t,n),Y(e.right,t,n)}}function $e(e,t){return`${X(e.left,t,0)} = ${X(e.right,t,0)}`}function X(e,t,n){let r=et(e),i;switch(e.kind){case`literal`:i=String(e.value);break;case`quantity`:i=tt(t,e.id);break;case`add`:i=`${X(e.left,t,r)} + ${X(e.right,t,r)}`;break;case`multiply`:i=`${X(e.left,t,r)} * ${X(e.right,t,r)}`}return r<n?`(${i})`:i}function et(e){return e.kind===`add`?1:e.kind===`multiply`?2:3}function tt(e,t){let n=e[t];if(n===void 0)throw Error(`No learner-facing name for canonical quantity ${t}.`);return n}function nt(e){return at(e,it(e))}function rt(t){let n=ft(t),{state:r,feedback:i,submission:a}=e[t.modeId].submit({problem:t.problem,locale:t.locale,answer:t.answer,names:n.learnerNames});return at(t,{state:r,feedback:i,submission:a})}function it(t){return e[t.modeId].start({problem:t.problem,locale:t.locale})}function at(e,t){let n=ft(e),r=lt(n);return{screen:ot(e,t.state,r,n),context:{locale:e.locale,themeId:n.themeId,story:n.story.text,quantities:r,replay:ut(e,n)},submission:t.submission,feedback:t.feedback}}function ot(e,t,n,r){let i=a[e.locale];switch(t.modeId){case`story-to-quantities`:return{modeId:`story-to-quantities`,source:{kind:`story`},target:{kind:`quantities`,prompt:i.storyToQuantities.prompt,quantities:n},input:t.input};case`quantities-to-named-equation`:return{modeId:`quantities-to-named-equation`,source:{kind:`quantities`,quantities:n},target:t.target,input:t.input};case`named-equation-to-academic-notation`:{let e=st(r);return{modeId:t.modeId,source:{...t.source,names:e},target:t.target,symbolKey:ct(t.target.symbols,r,t.source.relation),input:t.input}}case`academic-notation-to-named-equation`:return{modeId:t.modeId,source:t.source,target:{...t.target,names:st(r)},symbolKey:ct(t.source.symbols,r,t.source.relation),input:t.input}}}function st(e){return Object.fromEntries(e.facts.map(e=>[e.canonicalId,e.variableName]))}function ct(e,t,n){let r=new Set(Qe(n));return t.facts.flatMap(t=>r.has(t.canonicalId)?[{canonicalId:t.canonicalId,symbol:e[t.canonicalId],variableName:t.variableName}]:[])}function lt(e){return e.facts.map(e=>({id:e.canonicalId,themeQuantityId:e.themeQuantityId,label:e.label,variableName:e.variableName,displayValue:e.visibility===`known`?`${e.value} ${e.unit}`:`?`,role:e.role,given:e.visibility===`known`&&e.value!==void 0?{kind:`known`,value:e.value}:{kind:`hidden`}}))}function ut(e,t){return e.problem.replay?{...e.problem.replay,locale:e.locale,themeId:t.themeId,storySeed:t.story.storySeed}:void 0}function dt(e,t,n,r){let i=he[e];if(i===void 0)throw Error(`Unknown theme ${e}.`);return i.present({problem:t,locale:n,storySeed:r})}function ft(e){return dt(e.themeId,e.problem,e.locale,e.storySeed??e.problem.replay?.seed??0)}function pt(e,t){return mt(ge(e),t)}function mt(e,t){let n=new Map(t.facts.map(e=>[e.canonicalId,e.variableName]));return e.map(e=>({id:e.id,label:ht(e.relation,n),relation:e.relation}))}function ht(e,t){return $e(e,Object.fromEntries(t))}var gt=class extends J{static properties={choices:{attribute:!1},selectedChoiceId:{attribute:!1},legend:{attribute:!1},checkLabel:{attribute:!1}};static styles=y`
  ...
  `;constructor(){super(),this.value=``,this.inputLabel=`Named equation`,this.checkLabel=`Check`}render(){return z`
    ...
    `},text:{label:`Text input`,render:({screen:e,resources:t})=>z`
      ...
      ></named-equation-text-input>
    `}};function vt(e){return Object.hasOwn(Z,e)}var yt={render(e,t){t.textContent=e}},bt=class extends J{static properties={screen:{attribute:!1},knownLegend:{attribute:!1},unknownLegend:{attribute:!1},checkLabel:{attribute:!1}};static styles=y`
    :host {
      display: block;
      min-width: 0;
    }
  ...
  `;constructor(){super(),this.seed=17,this.themeId=`gaming.drone-power`,this.modeId=`story-to-quantities`,this.locale=`en`,this.menuLabel=`Puzzle menu`,this.scenarioLabel=`Scenario`,this.dronePowerLabel=`Spaceship and drones`,this.creatorFollowersLabel=`Creator and followers`,this.taskLabel=`Task`,this.storyToQuantitiesLabel=`Story to quantities`,this.quantitiesToNamedEquationLabel=`Quantities to named equation`,this.namedEquationToAcademicNotationLabel=`Named equation to academic notation`,this.academicNotationToNamedEquationLabel=`Academic notation to named equation`,this.seedLabel=`Seed`,this.showLabel=`Show puzzle`}render(){return z`
    ...
    `}handleSubmit(e){if(e.preventDefault(),!(e.currentTarget instanceof HTMLFormElement))return;let r=new FormData(e.currentTarget),i=r.get(`scenario`),a=r.get(`task`),o=Number(r.get(`seed`));typeof i==`string`&&t(i)&&typeof a==`string`&&s(a)&&Number.isInteger(o)&&this.dispatchEvent(new CustomEvent(n,{bubbles:!0,composed:!0,detail:{seed:o,themeId:i,modeId:a,locale:this.locale}}))}};customElements.get(`puzzle-menu`)===void 0&&customElements.define(`puzzle-menu`,St);function Ct(e,t){return wt(e,t,`display`)}function wt(e,t,n){return`${Q(e.left,t,n,0)} = ${Q(e.right,t,n,0)}`}function Q(e,t,n,r){let i=Et(e),a;switch(e.kind){case`literal`:a=String(e.value);break;case`quantity`:a=Dt(t,e.id);break;case`add`:a=`${Q(e.left,t,n,i)} + ${Q(e.right,t,n,i)}`;break;case`multiply`:{let r=Q(e.left,t,n,i),o=Q(e.right,t,n,i);a=n===`display`&&Tt(e.left,e.right)?`${r}${o}`:`${r}${n===`input`?`*`:` \\cdot `}${o}`;break}}return i<r?`(${a})`:a}function Tt(e,t){return e.kind===`literal`&&t.kind===`quantity`}function Et(e){switch(e.kind){case`add`:return 1;case`multiply`:return 2;case`literal`:case`quantity`:return 3}}function Dt(e,t){let n=e[t];if(n===void 0)throw Error(`No academic symbol for canonical quantity ${t}.`);return n}var Ot=class extends J{static properties={relation:{attribute:!1},symbols:{attribute:!1},adapter:{attribute:!1}};static styles=y`
    :host {
      display: block;
      min-width: 0;
    }
  ...
  `;constructor(){super(),this.relation=void 0,this.symbols={},this.adapter=yt}render(){return z`<div class="output" aria-label=${this.relation?Ct(this.relation,this.symbols):``}></div>`}updated(e){let t=this.renderRoot.querySelector(`.output`);t!==null&&this.relation!==void 0&&this.adapter.render(Ct(this.relation,this.symbols),t)}};customElements.get(`academic-notation-display`)===void 0&&customElements.define(`academic-notation-display`,Ot);var kt=class extends J{static properties={seed:{type:String},themeId:{attribute:`theme`,type:String},modeId:{attribute:`mode`,type:String},inputMode:{attribute:`input-mode`,reflect:!0,type:String},locale:{reflect:!0,type:String},academicDisplayAdapter:{attribute:!1},screen:{state:!0}};static styles=y`
    :host {
      display: block;
      min-width: 0;
  ...
  `;constructor(){super(),this.seed=`17`,this.themeId=`gaming.drone-power`,this.modeId=`story-to-quantities`,this.inputMode=`text`,this.locale=`en`,this.academicDisplayAdapter=yt,this.screen=void 0,this.generatedProblem=$(17)}willUpdate(e){e.has(`seed`)&&(this.generatedProblem=$(Number(this.seed))),(e.has(`seed`)||e.has(`themeId`)||e.has(`modeId`)||e.has(`locale`))&&(this.screen=this.composeCurrentScreen())}composeCurrentScreen(){if(t(this.themeId)&&r(this.locale))return nt({problem:this.generatedProblem,themeId:this.themeId,modeId:s(this.modeId)?this.modeId:`story-to-quantities`,locale:this.locale,storySeed:Number(this.seed)})}render(){if(!t(this.themeId))return z`<p role="alert">
      ...
      ${i===void 0||e.screen.modeId!==`named-equation-to-academic-notation`?null:z`<academic-notation-display
            ...
            .adapter=${this.academicDisplayAdapter}
          ></academic-notation-display>`}
    </div>`}renderNamedEquationInput(e){if(!vt(this.inputMode))return z`<p role="alert">
        Unknown input mode ${JSON.stringify(this.inputMode)}.
      </p>`;let n=this.screen;if(n===void 0||!t(this.themeId))return z``;let r=a[e],i=Z[this.inputMode],o=pt(this.generatedProblem,dt(this.themeId,this.generatedProblem,e,Number(this.seed)));return z`<div @puzzle-answer=${this.handleAnswer}>
      <nav aria-label=${r.controls.inputMode}>
        ${Object.keys(Z).map(e=>z`<button
            type="button"
      ...
      ${i.render({definition:{choices:o},screen:{...n,submission:n.submission},resources:r})}
    </div>`}handleAnswer(e){this.submitAnswer(e.detail)}submitAnswer(e){t(this.themeId)&&s(this.modeId)&&r(this.locale)&&(this.screen=rt({problem:this.generatedProblem,themeId:this.themeId,modeId:this.modeId,locale:this.locale,storySeed:Number(this.seed),answer:e}))}selectInputMode(e){this.inputMode=e,this.screen=this.composeCurrentScreen()}handleQuantitySelection(e){this.submitAnswer(e.detail)}handleLocaleChange(e){if(e.currentTarget instanceof HTMLSelectElement&&r(e.currentTarget.value)){let t=e.currentTarget.value;this.locale=t,this.requestApplicationState({locale:t})}}requestApplicationState(e){this.dispatchEvent(new CustomEvent(n,{bubbles:!0,composed:!0,detail:{seed:Number(this.seed),themeId:t(this.themeId)?this.themeId:`gaming.drone-power`,modeId:s(this.modeId)?this.modeId:`story-to-quantities`,locale:e.locale}}))}renderShell({locale:e,heading:t,prompt:n,source:r,input:i,feedback:o,replay:s}){let c=a[e];return z`
      <puzzle-shell
        .heading=${t}
      ...
      >
        ...
        ${s===void 0?null:z`<dl slot="replay" class="replay-list">
              <dt>${c.common.seed}</dt>
              <dd>${s.seed}</dd>
